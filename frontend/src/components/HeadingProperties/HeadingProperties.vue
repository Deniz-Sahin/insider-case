...
<template>
  <BasePropertyPanel title="Heading Properties">
    <!-- Content -->
    <PropertyGroup label="Content" html-for="heading-content">
      <textarea
        id="heading-content"
        v-model="content"
    ...
    <!-- Font Size -->
    <PropertyGroup label="Font Size" html-for="heading-font-size">
      <NumberSlider
    ...
    <!-- Color -->
    <PropertyGroup label="Text Color" html-for="heading-color">
      <ColorPicker id="heading-color" v-model="color" @update:model-value="updateColor" />
    </PropertyGroup>
